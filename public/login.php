...
<body class="bg-slate-100 min-h-screen flex flex-col items-center justify-center font-sans p-4">
    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div class="p-8">
            ...
            <form id="loginForm" action="../controllers/login_handler.php" method="POST"
    class="space-y-6">
    ...
    <div class="relative group">
        <i class="fa-solid fa-user absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-blue-500 transition"></i>

        <input type="text" name="username"
            autocomplete="username"
            class="w-full pl-10 pr-4 py-3 rounded-xl bg-white border border-gray-200 text-gray-900 placeholder-gray-400
                   focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-200"
            placeholder="Enter your username"
            data-required="true" data-error="Username is required.">
...
<div class="space-y-1.5">
    ...
    <div class="relative group">
        <i class="fa-solid fa-lock absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-blue-500 transition"></i>

        <input id="passwordInput" type="password" name="password"
            autocomplete="current-password"
            class="w-full pl-10 pr-10 py-3 rounded-xl bg-white border border-gray-200 text-gray-900 placeholder-gray-400
                   focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-200"
            placeholder="••••••••"
            data-required="true" data-error="Password is required.">
