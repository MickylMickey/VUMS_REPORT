...
<body class="bg-[#f8fafc] min-h-screen flex flex-col antialiased text-slate-900 pt-24">
                        ...
                        <thead>
                            <tr class="bg-slate-50/50">
                                ...
                                <th
                                    class="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-slate-500 border-b border-slate-200">
                                    Access Level</th>
                                <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-slate-500 border-b border-slate-200 text-right">
                                    Actions</th>
                            </tr>
                        </thead>
    ...
    class="hidden md:flex items-center gap-2 bg-blue-600 text-white px-4 py-1.5 rounded-xl h-10 font-semibold text-sm hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
    ...
    <button onclick="openArchiveUserModal('<?= $user_id ?>')"
        ...
        class="hidden md:flex items-center gap-2 bg-red-600 text-white px-4 py-1.5 rounded-xl h-10 font-semibold text-sm hover:bg-red-700 transition-all shadow-lg shadow-red-200">
