    ...
    <div class="flex-1 flex items-center justify-center px-6 lg:px-8">
        <div class="max-w-6xl w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full h-full py-10">
                ...
                <div class="rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative max-w-md mx-auto w-full h-[450px] lg:h-[600px] self-start flex flex-col"
                    ...
                    <div
                        class="px-6 py-10 text-center relative bg-transparent flex-1 flex flex-col justify-center items-center">
                        ...
                        <div class="flex justify-center -mt-16 mb-4 w-full">
                            <div class="relative inline-block">
                                ...
                                <div
                                    class="absolute bottom-2 right-2 w-5 h-5 bg-green-500 border-[3px] border-white rounded-full">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            <span
                                class="inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-100">
                                <?= htmlspecialchars($userData['role_name'] ?? 'User') ?>
                            </span>
                        </div>

                        <div class="mt-8 pt-6 flex justify-center w-full">
                            <button data-tooltip="Edit profile information"
            ...
            '../public/img/prof_pic/<?= htmlspecialchars($userData['user_prof'] ?? 'default.png') ?>'
                ...
                <div class="lg:col-span-2 self-start space-y-6 max-h-[80vh] overflow-y-auto pr-2">
                    ...
                    <div class="p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200 transition-shadow hover:shadow-md"
                        ...
                        <div class="grid sm:grid-cols-3 gap-4">
                            ...
                            <div
                                class="flex items-center gap-3 p-4 rounded-xl bg-white/60 border border-slate-200 shadow-sm hover:shadow-md transition">
                                <div
                            ...
                            <div
                                class="flex items-center gap-3 p-4 rounded-xl bg-white/60 border border-slate-200 shadow-sm hover:shadow-md transition">
                                <div
                                    class="w-10 h-10 flex items-center justify-center rounded-full bg-indigo-100 text-indigo-600">
                        ...
                        <div
                            class="mt-6 flex items-center gap-3 p-4 rounded-xl bg-white/60 border border-slate-200 shadow-sm">
                            <div
                    ...
                    <div class="p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200 transition-shadow hover:shadow-md"
                        ...
                        <div class="flex items-center gap-4 mb-4 pb-4 border-b border-black/50">
                            <div
                                class="w-12 h-12 flex items-center justify-center bg-purple-50 rounded-xl text-purple-600">
                ...
                <div id="editUserModal"
                    ...
                    <div id="editUserModalContent"
                        ...
                        <div class="px-8 py-5 flex justify-between items-center bg-white z-10 shrink-0">
                            <div>
                                <h2 class="text-xl font-bold text-slate-800 tracking-tight">Edit User Profile</h2>
                                <p class="text-[15px] text-slate-500 mt-0.5">Update personal details and account
                                    settings</p>
                            </div>
                            ...
                            <form id="editUserForm" method="POST" action="../controllers/edit_user_profile.php"
                                ...
                                <div class="flex flex-col sm:flex-row gap-8">
                                    <div class="shrink-0 flex flex-col items-center sm:items-start gap-3">
                                        ...
                                        <p class="text-[15px] text-slate-400 font-medium text-center w-32">Allowed: JPG,
                                            PNG
                                        </p>
                                    </div>
                        ...
                        <div
                            class="px-8 py-5 bg-slate-50 border-t border-slate-200 flex justify-end gap-3 z-10 shrink-0">
