                    ...
                    <div
                        ...
                        <div class="p-5 border-b border-slate-50 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="font-bold text-slate-800 leading-none">
                        ...
                        <div class="p-5 flex-grow">
                            ...
                            <?php if (!empty($sug['suggestion_img'])): ?>
                                ...
                                <div
                                    class="mt-4 overflow-hidden rounded-2xl border border-slate-100 relative group/img bg-black">
                                    <?php if ($isVideo): ?>
                                        ...
                                        <div
                                            class="absolute inset-0 flex items-center justify-center pointer-events-none group-hover/img:opacity-0 transition-opacity">
        ...
        <div id="statusConfirmModal" class="hidden"
            ...
            <div id="statusConfirmContainer"
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" style="height: 35px; width: 35px; color: #f59e0b;"
