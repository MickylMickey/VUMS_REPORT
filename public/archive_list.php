...
<body class="pt-24 bg-slate-50">
    ...
    data-tooltip="Search archived users by full name, username, or role"
                        ...
                        ?>
                            <tr class="report-row hover:bg-gray-50/50 transition-colors" 
                                ...
                                <td class="p-5 text-center">
                                    <span class="px-2 py-1 <?= $u['role_name'] === 'Admin' ? 'bg-red-600 text-white border-red-700' : 'bg-blue-50 text-blue-700 border-blue-100' ?> rounded-full text-[13px] font-bold uppercase tracking-wider border">
                                        <?= $roleName ?>
                                    </span>
                                </td>

                                <td class="p-4 text-center">
                                    <span class="px-2 py-1 bg-amber-50 text-amber-700 rounded-full text-[12px] font-bold uppercase tracking-wider border border-amber-100">
                                        Archived
                                    </span>
                                </td>
    ...
    <div class="flex items-center justify-center gap-2">
        ...
        <a href="../public/user_profile.php?u=<?= $u['user_id'] ?>"
           ...
           class="group inline-flex items-center justify-center w-12 h-12 rounded-xl
...
<button 
    ...
    data-tooltip="Restore this user"
    style="
        width: 48px;
        height: 48px;
        border-radius: 12px;
    ...
    <i class="fa-solid fa-rotate-left text-lg"></i>
        ...
        <button 
            ...
            <i class="fa-solid fa-trash-can text-lg group-hover:scale-110 transition-transform"></i>
        </button>
    ...
    <div id="restoreUserModal" class="fixed inset-0 z-[200] hidden items-center justify-center bg-slate-900/60 backdrop-blur-sm opacity-0 transition-all duration-300">
    ...
    <div id="restoreModalContent"
        ...
        <!-- ACTIONS -->
        <form action="../controllers/restore_user.php"
              method="POST"
            ...
            <!-- CANCEL (FIXED COLOR) -->
           <button type="button"
        onclick="toggleRestoreModal(false)"
        style="
            flex: 1;
            padding: 10px 16px;
            border-radius: 12px;
...
<div id="deletePermanentModal"
    ...
    <div id="deleteModalContent"
        ...
        <!-- Warning Bar -->
        <div class="bg-red-50 border-t border-b border-red-100 px-6 py-3 text-[15px] text-red-600 text-center font-medium">
            All user data will be permanently removed from the system.
        </div>

        <!-- Actions -->
        <form action="../controllers/delete_user_permanent.php"
              method="POST"
